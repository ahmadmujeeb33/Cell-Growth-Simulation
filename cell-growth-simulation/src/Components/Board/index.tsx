...
export const Board: React.FC<Board> = ({spreading,clearGrid, timeInterval, resetSimulation}) => {
    ...
    useColonySpread(spreading,setGrid, setChangedCells, timeInterval, resetSimulation);
